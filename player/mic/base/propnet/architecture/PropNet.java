package mic.base.propnet.architecture;
...
import mic.base.propnet.architecture.components.Transition;
...
public final class PropNet
{
	...
	/** References to every Proposition in the PropNet. */
	private final Set<Proposition> views;
	...
	public PropNet(List<Role> roles, Set<Component> components)
	{
		...
		this.views = new HashSet<Proposition>();
	...
	public Set<Proposition> getViews() {
		return views;
	}
